...
export default function DrawPage() {
  ...
  const predictDigit = async () => {
    ...
    try {
      ...
      setPredictionHistory((prev) => [
        { digit: data.prediction, confidence: data.confidence, timestamp: new Date() },
        ...prev.slice(0, 4),
      ])
    } catch (error) {
  ...
  const getConfidenceBadge = (conf) => {
    if (conf >= 95) return { text: "Excellent", variant: "default", color: "bg-green-100 text-green-800" }
    if (conf >= 85) return { text: "Good", variant: "secondary", color: "bg-blue-100 text-blue-800" }
    if (conf >= 75) return { text: "Fair", variant: "outline", color: "bg-yellow-100 text-yellow-800" }
    return { text: "Low", variant: "destructive", color: "bg-red-100 text-red-800" }
  }
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <span className="text-lg font-bold text-gray-900">AI Digit Recognition</span>
        ...
        <div className="max-w-7xl mx-auto">
              ...
              <Card className="shadow-xl border-0 bg-white/80 backdrop-blur-sm">
                <CardHeader className="pb-4">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-2">
                      <Button variant="outline" size="sm" onClick={() => setBrushSize(4)}>
                        <span
                          className={`w-2 h-2 rounded-full bg-gray-600 ${brushSize === 4 ? "ring-2 ring-blue-500" : ""}`}
                        ></span>
                      </Button>
                      <Button variant="outline" size="sm" onClick={() => setBrushSize(8)}>
                        <span
                          className={`w-3 h-3 rounded-full bg-gray-600 ${brushSize === 8 ? "ring-2 ring-blue-500" : ""}`}
                        ></span>
                      </Button>
                      <Button variant="outline" size="sm" onClick={() => setBrushSize(12)}>
                        <span
                  ...
                  <div className="flex flex-col items-center space-y-6">
                      ...
                      {isLoading && (
                        <div className="absolute inset-0 bg-white/80 backdrop-blur-sm rounded-2xl flex items-center justify-center">
                          <div className="text-center">
                            ...
                            <p className="text-gray-600 font-medium">Analyzing your drawing...</p>
                          </div>
                        </div>
                      )}
                    </div>
                    ...
                    <div className="flex flex-wrap gap-4 justify-center">
                      ...
                      >
                        ...
                        <span>{isLoading ? "Analyzing..." : "Predict Digit"}</span>
                      </Button>
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <div className="text-sm text-blue-800">
                          ...
                          <ul className="space-y-1 text-xs">
                            ...
                            <li>• Try different brush sizes for best results</li>
                          </ul>
                        </div>
                      </div>
                    </div>
                    ...
                    {prediction !== null && confidence !== null ? (
                      <>
                        <div className="space-y-4">
                          ...
                          <div>
                            <p className="text-2xl font-bold text-gray-900 mb-2">Predicted Digit: {prediction}</p>
                        ...
                        <div className="bg-gray-50 p-4 rounded-xl space-y-3">
                          ...
                          <div className="flex items-center justify-between text-sm">
                            ...
                            <span className="font-semibold text-blue-600">{processingTime}ms</span>
                          </div>
                          <div className="flex items-center justify-between text-sm">
                      ...
                      <div className="py-12">
                        ...
                        <div className="bg-gray-50 p-4 rounded-xl">
                          <p className="text-sm text-gray-600">
                            Our AI is ready to analyze your handwritten digits with healthcare-grade accuracy.
                          </p>
                        </div>
                      </div>
                    )}
                        ...
                        <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                          <div className="flex items-center space-x-3">
                            <div className="w-8 h-8 bg-blue-100 rounded-lg flex items-center justify-center">
                              <span className="font-bold text-blue-600">{item.digit}</span>
                            </div>
                            <div>
                              <div className="text-sm font-medium text-gray-900">Digit {item.digit}</div>
                ...
                <CardContent>
                  <div className="space-y-4 text-sm">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-semibold text-blue-900">2M+ Healthcare Samples</span>
                    </div>
                    <div className="flex justify-between">
          ...
          <Card className="mt-8 bg-gradient-to-r from-blue-50 via-indigo-50 to-purple-50 border-blue-200 shadow-xl">
            <CardContent className="pt-8 pb-8">
              <div className="text-center mb-8">
                <h3 className="text-2xl font-bold text-gray-900 mb-2">How Our AI Works</h3>
                <p className="text-gray-600">Advanced machine learning pipeline optimized for healthcare accuracy</p>
              </div>
              <div className="grid md:grid-cols-4 gap-6 text-center">
                <div className="space-y-3">
                  ...
                  <p className="text-sm text-gray-600">Normalize and enhance your drawing for optimal recognition</p>
                </div>
                <div className="space-y-3">
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-sm text-gray-600">Advanced neural network predicts the most likely digit</p>
                </div>
                <div className="space-y-3">
                  ...
                  <p className="text-sm text-gray-600">Calculate prediction confidence for healthcare reliability</p>
                </div>
              </div>
            </CardContent>
          </Card>
